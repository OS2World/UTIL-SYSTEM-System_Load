...
#if (defined(__IBMC__) && __IBMC__ <= 300) || (defined(__IBMCPP__) && __IBMCPP__ <= 300)

/* IBM VAC 3.08 requirements */
#ifdef INCL_LONGLONG
#error INCL_LONGLONG defined
#endif
...
unsigned short APIENTRY OSPMAcquireGlobalLock (void *);
unsigned short APIENTRY OSPMReleaseGlobalLock (void *);
